          ...
          <div className="fadein ">
            <div className="flex flex-col items-center">
              {previewImage ? (
                ...
                >
                  <img src={brands ? brands[selectedBrandCount - 1].imageLocation : ""} alt={""} className={`rounded-lg w-[60px] h-[60px]`} />
          ...
          {brands.map((item, index) => (
            <div key={item.id} className="flex flex-col  min-w-[70px]">
              ...
              >
                ...
                <img className="w-[60px] h-[60px]" alt={""} src={item.imageLocation ? item.imageLocation : ""} />
